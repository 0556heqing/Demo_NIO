...
public class SecureChatServerInitializer extends ChannelInitializer<SocketChannel> {
	...
	public void initChannel(SocketChannel ch) throws Exception {
		...
		if (SSLMODE.CA.toString().equals(tlsMode)) {
			engine = SSLContextFactory.getServerContext( tlsMode,
					System.getProperty("user.dir")+ "/src/main/resources/com/heqing/netty/ssl/client/sChat.jks", null)
					.createSSLEngine();
		} else if (SSLMODE.CSA.toString().equals(tlsMode)) {
			engine = SSLContextFactory.getServerContext( tlsMode,
					System.getProperty("user.dir") + "/src/main/resources/com/heqing/netty/ssl/twoway/sChat.jks",
					System.getProperty("user.dir") + "/src/main/resources/com/heqing/netty/ssl/twoway/sChat.jks")
					.createSSLEngine();
		} else {
